...
import { TrendingUp, ShieldCheck, ArrowRight, Wallet, CreditCard, Target, Sparkles, Zap } from 'lucide-react';
    ...
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '32px 24px', background: 'var(--bg-dark)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <Link to="/coach" className="btn-indigo">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '28px' }}>
        ...
        <div className="fintech-card" style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', marginBottom: '12px' }}>
            <span style={{ fontSize: '2.6rem', fontWeight: 800, color: '#FFF' }}>{profile.overallScore}</span>
            <span style={{ fontSize: '1.1rem', color: 'var(--text-muted)' }}>/ 100</span>
            <span className="badge-teal" style={{ marginLeft: 'auto' }}>Great</span>
          </div>

          <div style={{ fontSize: '0.82rem', color: 'var(--accent-teal)', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <div className="fintech-card" style={{ padding: '24px' }}>
          ...
          <div style={{ fontSize: '2.2rem', fontWeight: 800, color: '#FFF', marginBottom: '6px' }}>
        ...
        <div className="fintech-card" style={{ padding: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <span className="badge-teal">↑ 12.4% vs last month</span>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px', marginBottom: '28px' }}>
        ...
        <div className="fintech-card" style={{ padding: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            <div>
              <div style={{ fontSize: '0.95rem', fontWeight: 700, color: '#FFF' }}>Cash Flow Breakdown</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div style={{ background: 'rgba(5, 9, 20, 0.6)', padding: '14px', borderRadius: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <div style={{ fontSize: '0.85rem', fontWeight: 600, color: '#FFF' }}>Needs (Essential)</div>
            ...
            <div style={{ background: 'rgba(5, 9, 20, 0.6)', padding: '14px', borderRadius: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <div style={{ fontSize: '0.85rem', fontWeight: 600, color: '#FFF' }}>Wants (Discretionary)</div>
        ...
        <div className="fintech-card-elevated" style={{ padding: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: '1px solid var(--border-indigo)' }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#FFF', marginBottom: '8px', lineHeight: 1.4 }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <Link to="/transactions" className="btn-indigo" style={{ padding: '10px 16px', fontSize: '0.85rem', flex: 1, justifyContent: 'center' }}>
              View Details
            </Link>
      ...
      <div style={{ marginBottom: '28px' }}>
        <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#FFF', marginBottom: '16px' }}>AI Financial Decision Modules</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
          
          <Link to="/simulator" className="fintech-card-interactive" style={{ padding: '20px', textDecoration: 'none' }}>
            <Zap size={20} color="var(--primary-indigo)" style={{ marginBottom: '12px' }} />
          ...
          <Link to="/simulator" className="fintech-card-interactive" style={{ padding: '20px', textDecoration: 'none' }}>
            <TrendingUp size={20} color="var(--accent-teal)" style={{ marginBottom: '12px' }} />
          ...
          <Link to="/decisions" className="fintech-card-interactive" style={{ padding: '20px', textDecoration: 'none' }}>
            <ShieldCheck size={20} color="var(--accent-amber)" style={{ marginBottom: '12px' }} />
