...
import { ArrowRight, ShieldCheck, Play, Sparkles, TrendingUp, Cpu, CreditCard, ChevronRight, Zap, Target, Lock, CheckCircle, BarChart3, HelpCircle } from 'lucide-react';
  ...
  return (
    <div style={{ background: 'var(--bg-dark)', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', padding: '80px 24px 100px 24px', maxWidth: '1280px', margin: '0 auto' }}>
        ...
        {/* Subtle Ambient Glow */}
        <div style={{ position: 'absolute', top: '-10%', right: '10%', width: '500px', height: '500px', background: 'radial-gradient(circle, rgba(65, 105, 225, 0.12) 0%, transparent 70%)', pointerEvents: 'none', filter: 'blur(60px)' }} />

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '48px', alignItems: 'center' }}>
          
          {/* Left Column: Headlines */}
          <div>
            <div className="badge-indigo" style={{ marginBottom: '20px' }}>
              <Sparkles size={14} /> AI-Powered Financial Operating System
            </div>
            
            <h1 style={{ fontSize: '3.6rem', fontWeight: 800, lineHeight: 1.1, marginBottom: '24px', color: '#FFF' }}>
              Your money.<br />
              <span style={{ background: 'linear-gradient(135deg, #4169E1 0%, #D7B56D 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                In motion.
              </span>
            </h1>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
              <Link to="/register" className="btn-indigo" style={{ padding: '14px 28px', fontSize: '1rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginTop: '40px', paddingTop: '24px', borderTop: '1px solid var(--border-subtle)' }}>
              <div style={{ display: 'flex' }}>
                {['#4169E1', '#D7B56D', '#54C7A3'].map((c, i) => (
                  <div key={i} style={{ width: '32px', height: '32px', borderRadius: '50%', background: c, border: '2px solid #050914', marginLeft: i > 0 ? '-10px' : '0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.75rem', fontWeight: 700, color: '#000' }}>
                    {String.fromCharCode(65 + i)}
                  </div>
                ))}
              </div>
              <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                Trusted by <strong style={{ color: '#FFF' }}>50,000+</strong> everyday Indian households
              </div>
            </div>
          </div>
          ...
          <div className="fintech-card-elevated animate-float" style={{ padding: '28px', position: 'relative' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <div>
                ...
                <div style={{ fontSize: '2.2rem', fontWeight: 800, color: '#FFF', marginTop: '2px' }}>₹1,00,000</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '24px' }}>
              <div style={{ background: 'rgba(10, 16, 32, 0.7)', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-subtle)' }}>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Needs (52%)</div>
                <div style={{ fontSize: '1rem', fontWeight: 700, color: '#FFF', marginTop: '4px' }}>₹52,400</div>
              </div>
              <div style={{ background: 'rgba(10, 16, 32, 0.7)', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-subtle)' }}>
                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Wants (20%)</div>
                <div style={{ fontSize: '1rem', fontWeight: 700, color: '#FFF', marginTop: '4px' }}>₹19,600</div>
              </div>
              <div style={{ background: 'rgba(10, 16, 32, 0.7)', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-subtle)' }}>
            ...
            <div style={{ height: '80px', position: 'relative', overflow: 'hidden', background: 'rgba(5, 9, 20, 0.5)', borderRadius: '10px', padding: '12px' }}>
              <svg width="100%" height="100%" viewBox="0 0 300 60" preserveAspectRatio="none">
                <path d="M 10 30 C 80 30, 120 10, 290 10" fill="none" stroke="#4169E1" strokeWidth="3" opacity="0.8" />
                <path d="M 10 30 C 80 30, 120 30, 290 30" fill="none" stroke="#E4A94B" strokeWidth="3" opacity="0.8" />
                <path d="M 10 30 C 80 30, 120 50, 290 50" fill="none" stroke="#54C7A3" strokeWidth="3" opacity="0.8" />
              </svg>
            </div>
          </div>
      ...
      <section style={{ padding: '80px 24px', background: 'var(--bg-surface-secondary)', borderTop: '1px solid var(--border-subtle)', borderBottom: '1px solid var(--border-subtle)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <div style={{ fontSize: '0.8rem', color: 'var(--primary-indigo)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' }}>1. Watch Your Money Move</div>
            <h2 style={{ fontSize: '2.4rem', fontWeight: 800, color: '#FFF' }}>Where it goes. What it means.</h2>
          ...
          <div className="fintech-card" style={{ padding: '36px', position: 'relative' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '24px', alignItems: 'center' }}>
              <div style={{ background: 'rgba(5, 9, 20, 0.8)', padding: '24px', borderRadius: '16px', border: '1px solid var(--primary-indigo-glow)' }}>
                <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Monthly Income Received</div>
                <div style={{ fontSize: '2rem', fontWeight: 800, color: '#FFF', marginTop: '4px' }}>₹1,00,000</div>
                <div className="badge-indigo" style={{ marginTop: '12px' }}>Salary Credit</div>
              </div>

              {/* Flow Arrows / Channels */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ background: 'rgba(65, 105, 225, 0.1)', border: '1px solid rgba(65, 105, 225, 0.3)', padding: '16px', borderRadius: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                    <span style={{ fontWeight: 700, color: '#FFF' }}>Needs (52%)</span>
                    <span style={{ fontWeight: 700, color: '#FFF' }}>₹52,400</span>
                  </div>
                  <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>Rent, EMI, Utilities, Groceries</div>
                </div>

                <div style={{ background: 'rgba(228, 169, 75, 0.1)', border: '1px solid rgba(228, 169, 75, 0.3)', padding: '16px', borderRadius: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                    <span style={{ fontWeight: 700, color: '#FFF' }}>Wants (20%)</span>
                    <span style={{ fontWeight: 700, color: '#FFF' }}>₹19,600</span>
                  </div>
                  <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>Dining out, Shopping, Entertainment</div>
                </div>

                <div style={{ background: 'rgba(84, 199, 163, 0.1)', border: '1px solid rgba(84, 199, 163, 0.3)', padding: '16px', borderRadius: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                    <span style={{ fontWeight: 700, color: 'var(--accent-gold)' }}>Future (28%)</span>
      ...
      <section style={{ padding: '80px 24px', maxWidth: '1280px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '48px', alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: '0.8rem', color: 'var(--primary-indigo)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' }}>2. Can I Afford This?</div>
          ...
          <div className="fintech-card-elevated" style={{ padding: '28px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px', paddingBottom: '16px', borderBottom: '1px solid var(--border-subtle)' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--primary-indigo)', marginTop: '2px' }}>₹79,999</div>
              </div>
            </div>
            ...
            <div className="badge-amber" style={{ width: '100%', justifyContent: 'center', padding: '10px', fontSize: '0.85rem' }}>
      ...
      <section style={{ padding: '80px 24px', background: 'var(--bg-surface-secondary)', borderTop: '1px solid var(--border-subtle)', borderBottom: '1px solid var(--border-subtle)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <div style={{ fontSize: '0.8rem', color: 'var(--primary-indigo)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' }}>3. Loans & EMI Calculator</div>
            <h2 style={{ fontSize: '2.4rem', fontWeight: 800, color: '#FFF' }}>Understand the true cost of borrowing.</h2>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '32px' }}>
            ...
            <div className="fintech-card" style={{ padding: '28px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div>
                  ...
                  <input type="range" min="100000" max="5000000" step="50000" value={loanAmount} onChange={e => setLoanAmount(Number(e.target.value))} style={{ width: '100%', accentColor: '#D7B56D' }} />
                </div>

                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', fontSize: '0.9rem' }}>
                    <span style={{ color: 'var(--text-muted)' }}>Interest Rate (% p.a.)</span>
                    <span style={{ fontWeight: 700, color: 'var(--primary-indigo)' }}>{interestRate}%</span>
                  </div>
                  <input type="range" min="7.0" max="18.0" step="0.25" value={interestRate} onChange={e => setInterestRate(Number(e.target.value))} style={{ width: '100%', accentColor: '#4169E1' }} />
                </div>

                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', fontSize: '0.9rem' }}>
                    <span style={{ color: 'var(--text-muted)' }}>Tenure (Years)</span>
                    <span style={{ fontWeight: 700, color: 'var(--accent-teal)' }}>{tenureYears} Years</span>
                  </div>
                  <input type="range" min="1" max="10" step="1" value={tenureYears} onChange={e => setTenureYears(Number(e.target.value))} style={{ width: '100%', accentColor: '#54C7A3' }} />
                </div>
              </div>
            </div>
            ...
            <div className="fintech-card-elevated" style={{ padding: '28px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                ...
                <div style={{ fontSize: '2.8rem', fontWeight: 800, color: 'var(--primary-indigo)', marginTop: '4px' }}>
              ...
              <Link to="/loans" className="btn-indigo" style={{ marginTop: '24px', justifyContent: 'center' }}>
      ...
      <section style={{ padding: '80px 24px', maxWidth: '1280px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          <div style={{ fontSize: '0.8rem', color: 'var(--primary-indigo)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' }}>4. FutureView Digital Twin</div>
          <h2 style={{ fontSize: '2.4rem', fontWeight: 800, color: '#FFF' }}>Your future isn't fixed.</h2>
        ...
        <div className="fintech-card-elevated" style={{ padding: '28px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
            ...
            <div style={{ width: '280px' }}>
              ...
              <input type="range" min="0" max="30000" step="2500" value={extraSavings} onChange={e => setExtraSavings(Number(e.target.value))} style={{ width: '100%', accentColor: '#D7B56D' }} />
            </div>
          </div>
          ...
          <div style={{ height: '240px', width: '100%' }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={futureChartData}>
                ...
                <Area type="monotone" dataKey="optimized" stroke="#D7B56D" strokeWidth={3} fillOpacity={1} fill="url(#optGrad)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
      ...
      <footer style={{ borderTop: '1px solid var(--border-subtle)', padding: '40px 24px', background: 'var(--bg-surface-secondary)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <div style={{ fontSize: '1.2rem', fontWeight: 800, color: '#FFF' }}>ARTHA AI</div>
            <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginTop: '4px' }}>Understand Your Money. Build Your Future.</div>
          </div>
          <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
            Built by <strong style={{ color: 'var(--accent-gold)' }}>Aditya Prakash</strong> • © 2026 Artha AI
          </div>
        </div>
      </footer>
